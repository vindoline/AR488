...
// Updated by JFQ 5/12/2019
#define FWVER "AR488 GPIB controller, version 0.46.21, 05/12/2019"
...
/*
   ...
   Updated by JFQ on 5/12/2019 to increase timeout range from 3 to 10 seconds
*/
void rtmo_h(char *params) {
  ...
  if (params != NULL) {
    ...
    if (val < 1 || val > 10000) {
      errBadCmd();
      if (isVerb) Serial.println(F("Invalid: valid timout range is 1 - 10000 ms."));
      return;
    }
    AR488.rtmo = val;
    if (isVerb) {
